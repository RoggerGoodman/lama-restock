...
def process_N_sales(package_size, deviation_corrected, real_need, expected_packages, req_stock, stock, package_consumption, current_gap, trend, helper: Helper):
    ...
    if package_consumption >= 0.3:
        ...
        if deviation_corrected >= 45 and (stock - req_stock) <= package_size:
